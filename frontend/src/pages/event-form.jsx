...
export default function EventForm({ setSpotifyEventPk }) {
  ...
  useEffect(() => {
    ...
    if (pk) {
      axios
        .get(`https://potluck.herokuapp.com/events/${pk}`, {
          headers: {
        ...
        .then((response) => {
          ...
          setDateTime(
            moment(
              `${response.data.date_scheduled} ${response.data.time_scheduled}`
            )
          );
          if (response.data?.end_time)
            setEndTime(
              moment(
                `${response.data.date_scheduled} ${response.data?.end_time}`
              )
            );
          ...
          if (response.data.playlist_link)
  ...
  function handleSaveEvent(e) {
    ...
    const options = {
      ...
      url:
        formState === "edit"
          ? `https://potluck.herokuapp.com/events/${pk}`
          ...
          <div className="mt-8 mb-4 w-80">
            <div className="flex flex-col gap-5">
              ...
              <div>
                ...
                {!showAddress && (
                  <Typography
                    className="text-right font-bold text-blue-900 hover:text-blue-500 cursor-pointer"
              ...
              <div className="">
                <div className="flex flex-row mb-1">
                  ...
                  >
                    <span
                      aria-hidden="true"
                      className={`${isTipOn ? "translate-x-7" : "translate-x-0"}
              ...
              <div className="">
                <div className="flex flex-row mb-1">
                  <Switch
                    ...
                    onChange={setIsPlaylistOn}
                  >
                    <span
                      aria-hidden="true"
                      className={`${
                        isPlaylistOn ? "translate-x-7" : "translate-x-0"
                      }
                    pointer-events-none inline-block h-[24px] w-[24px] transform rounded-full bg-white shadow-lg ring-0 transition duration-200 ease-in-out`}
                    />
                  </Switch>
                ...
                {playlistLink !== false && isPlaylistOn && (
                  <div className="flex">
                    <span className=" self-center mr-1">
                      <FontAwesomeIcon
                        icon={faSpotify}
                  ...
                  <div className="flex border-l-2 pl-4 mt-2">
                    <p>
                      ...
                      <FontAwesomeIcon
                        ...
                        size="lg"
                      />
                      You will be taken to Spotify.com to authorize your
                      credentials, and a collaborative playlist will be made on
                      your account. Or,{" "}
                      <span
                      ...
                      >
                        {" "}
                        click to insert a custom playlist link.
                      </span>{" "}
                    </p>
                  </div>
                )}
